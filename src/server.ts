 ...
 *
 * Demonstrates the OAuth integration with mcp-use using Auth0 as the
...
/**
 * Returns authenticated user information extracted from the Auth0 JWT.
 */
server.tool(
  {
    name: "get-user-info",
...
/**
 * Demonstrates making authenticated API calls to Auth0 using the bearer token.
 */
server.tool(
  {
